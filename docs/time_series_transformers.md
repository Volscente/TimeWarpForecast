...
Historically, Time Series Forecasting models can be divided into:
1. Classical models
2. Deep Learning model &rarr; Involving encoder-decoder components, like RNN and they variants
...
### Distillation
The Encoder extracts the long-range dependencies and outputs them as a Feature Map.
After creating the Feature Map from the *ProbSparse* Self-Attention, there would be a lot of redundant information.
Distillation is performed through a 1D Convolutional Layer and a Max Pooling Layer.
